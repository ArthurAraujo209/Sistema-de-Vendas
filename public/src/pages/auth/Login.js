...
export function LoginPage() {
  ...
  content.innerHTML = `
    <div class="auth-container">
      <div class="auth-card" style="background-color: #932beb;">
        ...
        <form id="login-form" class="auth-form">
          <div class="form-group">
            ...
            <input type="email" id="email" class="form-input" required placeholder="seu@email.com" autocomplete="email" style="background-color: #fff; color: #252525;">
          </div>
          <div class="form-group">
            <label for="password" style="color: #fff;">Senha</label>
            <input type="password" id="password" class="form-input" required placeholder="Mínimo 6 caracteres" autocomplete="current-password" style="background-color: #fff; color: #252525;">
          </div>
          <button type="submit" class="btn btn-primary btn-block" id="login-submit" style="background-color: var(--yellow); color: #252525;">Entrar</button>
        </form>
        <div class="auth-divider" style="color: #fff;"><span>ou</span></div>
        <button id="google-login-btn" class="btn btn-outline btn-block google-btn" style="background-color: #fff; color: #252525;">
        ...
        <div class="auth-footer">
          <p style="color: #cacaca;">Não tem conta? <a href="#/register" style="color: var(--yellow);">Cadastre-se como cliente</a></p>
          <p style="color: #cacaca;">Quer vender? <a href="#/seller-request" style="color: var(--yellow);">Solicite conta de vendedor</a></p>
        </div>
      </div>
    </div>
  `;
